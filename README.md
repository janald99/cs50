# About this Project
This project features a Wikipedia-like online encyclopedia.
...
- Markdown to HTML Conversion:
  ...
  - Challenge for those more comfortable: If you’re feeling more comfortable, try implementing the Markdown to HTML conversion without using any external libraries, supporting headings, boldface text, unordered lists, links, and paragraphs.
...
1. **Clone the Project Repository:**
    ...
    ```
    At the main project directory level, you should be able to see files like manage.py, and folders like wiki and project1.

2. **Navigate to Wiki branch:**
    ```bash
