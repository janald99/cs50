document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('#add-show').addEventListener('click', add_show);
  
    // // By default, load the inbox
    // load_mailbox('inbox');
    
    // Add event listener to compose form submission
    document.querySelector('#add-show-form').addEventListener('submit', post_show);
  });
  ...
  function post_show() {
    ...
    const image_url = document.querySelector('#add-show-image').value;
    ...
    .then(result => {
      ...
      // Once the show has been added, load the "All shows" list
    //   load_mailbox('sent');
    })
    .catch(error => {
  ...
  function new_show() {
    ...
    document.querySelector('#show-list-view').style.display = 'none';
    document.querySelector('#add-show-view').style.display = 'block';
